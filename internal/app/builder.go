...
func (b *Builder) Build() (*App, error) {
	...
	if b.config.OAuth2AuthServer.UpstreamAuthorizeEndpoint != "" || b.config.OAuth2AuthServer.Mode == "issue_token" {
		...
		if cimdCfg.Enabled {
			...
			clientResolver = oauth2service.NewAgentClientResolver(b.storage.Agents(), cimdSvc, b.logger)
			...
			clientResolver = oauth2service.NewAgentClientResolver(b.storage.Agents(), nil, b.logger)
		}
