...
require (
	...
	github.com/aws/aws-cryptographic-material-providers-library v1.11.1 // indirect
	github.com/aws/aws-encryption-sdk/releases/go/encryption-sdk v0.3.0 // indirect
