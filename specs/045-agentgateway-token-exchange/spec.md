...
- **FR-007**: If the Broker rejects or cannot complete an exchange, the direct route MUST fail closed: its MCP route MUST return an agent-visible HTTP 500 and MUST NOT forward the inbound credential or the request to the protected backend.
